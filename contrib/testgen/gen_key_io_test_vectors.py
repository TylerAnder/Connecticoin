...
bech32_templates = [
  ...
  ('ctc',   0, 20, (False, 'main',    None, True), p2wpkh_prefix),
  ('ctc',   0, 32, (False, 'main',    None, True), p2wsh_prefix),
  ('ctc',   1,  2, (False, 'main',    None, True), (OP_1, 2)),
  ('tctc',  0, 20, (False, 'test',    None, True), p2wpkh_prefix),
  ('tctc',  0, 32, (False, 'test',    None, True), p2wsh_prefix),
  ('tctc',  2, 16, (False, 'test',    None, True), (OP_2, 16)),
  ('rctc',  0, 20, (False, 'regtest', None, True), p2wpkh_prefix),
  ('rctc',  0, 32, (False, 'regtest', None, True), p2wsh_prefix),
  ('rctc', 16, 40, (False, 'regtest', None, True), (OP_16, 40))
]
# templates for invalid bech32 sequences
bech32_ng_templates = [
  # hrp, version, witprog_size, invalid_bech32, invalid_checksum, invalid_char
  ('tc',    0, 20, False, False, False),
  ('tctc',  17, 32, False, False, False),
  ('rctc',  3,  1, False, False, False),
  ('ctc',   15, 41, False, False, False),
  ('tctc',  0, 16, False, False, False),
  ('rctc',  0, 32, True,  False, False),
  ('ctc',   0, 16, True,  False, False),
  ('tctc',  0, 32, False, True,  False),
  ('rctc',  0, 20, False, False, True)
]
