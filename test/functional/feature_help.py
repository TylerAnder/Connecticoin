...
"""Verify that starting connecticoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start connecticoin with -h for help text")
        ...
        self.log.info("Start connecticoin with -version for version information")
        ...
        self.log.info("Start connecticoind with -fakearg to make sure it does not start")
