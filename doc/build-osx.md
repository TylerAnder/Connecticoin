...
1. Clone the ConnectiCoin Core source code:

        git clone https://github.com/ConnectiCoin/ConnectiCoin
        cd connecticoin

2.  Build ConnectiCoin Core:

    Configure and build the headless ConnectiCoin Core binaries as well as the GUI (if Qt is found).
...
Before running, you may create an empty configuration file:
    ...
    mkdir -p "/Users/${USER}/Library/Application Support/ConnectiCoin"

    touch "/Users/${USER}/Library/Application Support/ConnectiCoin/connecticoin.conf"

    chmod 600 "/Users/${USER}/Library/Application Support/ConnectiCoin/connecticoin.conf"

The first time you run connecticoind, it will start downloading the blockchain. This process could take many hours, or even days on slower than average systems.
