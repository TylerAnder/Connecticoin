...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " connecticoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  connecticoin-tx [options] <hex-tx> [commands]  Update hex-encoded connecticoin transaction\n" +
            "or:     connecticoin-tx [options] -create [commands]   Create hex-encoded connecticoin transaction\n" +
            "\n";
