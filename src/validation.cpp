...
#if defined(NDEBUG)
# error "ConnectiCoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "ConnectiCoin Signed Message:\n";
...
CAmount GetBlockSubsidy(int nHeight, const Consensus::Params& consensusParams)
{
    ...
    // Subsidy is cut in half every 3,200,000 blocks which will occur approximately every 3 years.
    nSubsidy >>= halvings;
    return nSubsidy;
}
...
void ThreadScriptCheck() {
    RenameThread("connecticoin-scriptch");
